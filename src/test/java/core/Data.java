...
public class Data {
    ...
    public static final String originalTextFilePath = new File("src/test/resources/test/original_text.txt").getAbsolutePath();
    public static final String plagiarismTextFilePath = new File("src/test/resources/test/plagiarism_text.txt").getAbsolutePath();
